...
function initializeClientInquiryForm() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            errorDiv.innerHTML = `<p>Unable to submit form. Please email us directly at info@craftconnectstaffing.com or call (401) 558-7778.</p>`;
...
function initializeJobApplicationForm() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const errorDiv = document.createElement('div');
            errorDiv.className = 'error-message';
            errorDiv.innerHTML = `<p>Unable to submit application. Please email your resume to info@craftconnectstaffing.com</p>`;
            form.insertBefore(errorDiv, form.firstChild);
